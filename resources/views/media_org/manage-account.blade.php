    ...
    setTimeout(() => {
        ...
        if (alertBox) {
            ...
            setTimeout(() => alertBox.remove(), 500); // Remove from DOM
                                            ...
                                            <form method="POST" action="{{ route('media_organizations.update', $mediaOrganization->id) }}" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" name="phone" id="lastname" value="{{ $mediaOrganization->phone }}">
                                                        </div>
                                                    </div> <!-- end col -->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="nindetails" name="nindetails" placeholder="Enter NIN Details" value="{{ $mediaOrganization->nin_details }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
...
<div class="col-md-6">
    ...
    <div class="form-check">
    <input class="form-check-input" type="checkbox" name="tv_peak_viewing_times" value="Morning" id="Morning">

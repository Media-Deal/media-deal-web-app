...
Route::prefix('media-org')->middleware(['user_auth', 'role:media_org'])->group(function () {
    ...
    Route::post('/update-details', [ManageAccountController::class, 'updateDetails'])->name('media_organizations.update');
    Route::post('/update-tvdetails', [ManageAccountController::class, 'updatetvDetails'])->name('media_organizationstv.update');
    Route::post('/update-radiodetails', [ManageAccountController::class, 'updateradioDetails'])->name('media_organizationsradio.update');
    Route::post('/update-internetdetails', [ManageAccountController::class, 'updateinternetDetails'])->name('media_organizationsinternet.update');
